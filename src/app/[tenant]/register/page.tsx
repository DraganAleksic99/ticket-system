...
export default async function Registration({ params }: { params: Params }) {
  ...
  return (
    <form method="POST" action={urlPath("/auth/register", tenant as string)}>
